...
def vit_small_patch16_224(pretrained=False, **kwargs):
    ...
    model.pretrained_cfg = default_cfgs['vit_small_patch16_224']
    if pretrained:
        load_pretrained(
...
def dino_base_patch8_224(pretrained=False, **kwargs):
    ...
    model.pretrained_cfg = default_cfgs['dino_base_patch8_224']
    if pretrained:
...
def vit_base_patch16_384(pretrained=False, **kwargs):
    model = VisionTransformer(
        ...
        norm_layer=partial(nn.LayerNorm, eps=1e-6), **kwargs)
    model.pretrained_cfg = default_cfgs['vit_base_patch16_384']
    if pretrained:
        load_pretrained(model, num_classes=model.num_classes, in_chans=kwargs.get('in_chans', 3))
    return model
...
def vit_base_patch32_384(pretrained=False, **kwargs):
    model = VisionTransformer(
        ...
        norm_layer=partial(nn.LayerNorm, eps=1e-6), **kwargs)
    model.pretrained_cfg = default_cfgs['vit_base_patch32_384']
    if pretrained:
        load_pretrained(model, num_classes=model.num_classes, in_chans=kwargs.get('in_chans', 3))
    return model
...
def vit_large_patch16_224(pretrained=False, **kwargs):
    model = VisionTransformer(
        ...
        norm_layer=partial(nn.LayerNorm, eps=1e-6), **kwargs)
    model.pretrained_cfg = default_cfgs['vit_large_patch16_224']
    if pretrained:
        load_pretrained(model, num_classes=model.num_classes, in_chans=kwargs.get('in_chans', 3))
    return model
...
def vit_large_patch16_384(pretrained=False, **kwargs):
    model = VisionTransformer(
        ...
        norm_layer=partial(nn.LayerNorm, eps=1e-6), **kwargs)
    model.pretrained_cfg = default_cfgs['vit_large_patch16_384']
    if pretrained:
        load_pretrained(model, num_classes=model.num_classes, in_chans=kwargs.get('in_chans', 3))
    return model
...
def vit_large_patch32_384(pretrained=False, **kwargs):
    model = VisionTransformer(
        ...
        norm_layer=partial(nn.LayerNorm, eps=1e-6), **kwargs)
    model.pretrained_cfg = default_cfgs['vit_large_patch32_384']
    if pretrained:
        load_pretrained(model, num_classes=model.num_classes, in_chans=kwargs.get('in_chans', 3))
    return model
...
def vit_huge_patch16_224(pretrained=False, **kwargs):
    ...
    model.pretrained_cfg = default_cfgs['vit_huge_patch16_224']
    return model
...
def vit_huge_patch32_384(pretrained=False, **kwargs):
    ...
    model.pretrained_cfg = default_cfgs['vit_huge_patch32_384']
    return model
...
def vit_small_resnet26d_224(pretrained=False, **kwargs):
    ...
    model.pretrained_cfg = default_cfgs['vit_small_resnet26d_224']
    return model
...
def vit_small_resnet50d_s3_224(pretrained=False, **kwargs):
    ...
    model = VisionTransformer(
        img_size=224, embed_dim=768, depth=8, num_heads=8, mlp_ratio=3, hybrid_backbone=backbone, **kwargs)
    model.pretrained_cfg = default_cfgs['vit_small_resnet50d_s3_224']
    return model
...
def vit_base_resnet26d_224(pretrained=False, **kwargs):
    ...
    model.pretrained_cfg = default_cfgs['vit_base_resnet26d_224']
    return model
...
def vit_base_resnet50d_224(pretrained=False, **kwargs):
    ...
    model = VisionTransformer(
        img_size=224, embed_dim=768, depth=12, num_heads=12, mlp_ratio=4, hybrid_backbone=backbone, **kwargs)
    model.pretrained_cfg = default_cfgs['vit_base_resnet50d_224']
    return model
